    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        _variablesContract = 0xaB6F06762e382eBe0Bb47715F028B2b032Ad3291;
    ...
    function isStaked(address _userAddress) public view returns (bool) {
        ...
        uint256 userLastStakingEndTime = userLastStakingInfo.startTime + userLastStakingInfo.duration;

        if (userAccount.stakingIDs.length > 0 && _currentTime < userLastStakingEndTime) {
           return true;
        }
