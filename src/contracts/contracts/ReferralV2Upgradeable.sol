    ...
    UUPSUpgradeable
{
    ...
    function updateIDTopUpDetails(
        uint32[] calldata _id,
        uint256[] calldata _lastTopUp,
        uint256[] calldata _roiClaimed,
        uint256[] calldata _activationTime,
        uint256[] calldata _joiningTime
    ) external onlyAdmin {
