...
export const UserCard = memo(({onOpen, heading, icon, userIDAccountJSON}: {onOpen: () => void, heading: string, icon: IconType, userIDAccountJSON: string}) => {
    const userIDAccount: userIDAccountType = JSON.parse(userIDAccountJSON)
  return (
    <CardContainer
    onClick={onOpen}
  >
